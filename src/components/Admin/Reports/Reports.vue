                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="text-center m-5" v-else-if="error">
                                    <h3 class="text-danger">Reports not found Add new Alert</h3>
                                </div>
            ...
            <div class="modal-content">
                        ...
                        <div class="row g-2 mt-1">
                            <div class="col-6">
                                <div class="card">
                                    ...
                                    <div class="mt-1 mx-5">
                                        <input type="text" class="form-control" id="exampleFormControlInput1" v-model="searchQuery" placeholder="search by alert name">
                                    </div>
                                    <perfect-scrollbar style="height: 240px;">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center" v-for="data in filteredGroupData" :key="data.id">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" :id="'edit-report-' + data.id" :checked="isSelected(data.id)" v-on:click="handleSessionsCheck($event, data.id, data.name)">
                                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <perfect-scrollbar style="height: 280px;">
                                        ...
                                        <div class="card-body" v-else>
                                            <div class="d-flex align-items-center" v-for="data in selectedAlert" :key="data.id">
                                                <a href="#" class="text-decoration-none" style="color: #b63d3d;" @click="handleCancel(data.id)"><i class="fa-solid fa-xmark"></i></a>
                                                <p class="sessionFormText me-1">{{ data?.name }}</p>
                                            </div>
                                        </div>
                                    </perfect-scrollbar>
                ...
                <div class="modal-footer">
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button" data-bs-dismiss="modal" @click="handleUpdateReports" class="modelSaveBtn ms-2">Save</button>
                    </div>
                </div>
            </div>
        </div>
